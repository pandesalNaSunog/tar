...
Route::group(['middleware' => ['auth:sanctum']], function(){
    ...
    Route::post('/mechanics', [ShopMechanicController::class, 'getMechanics']);
    ...
    Route::post('/shops', [ShopMechanicController::class, 'getShops']);
    ...
    Route::post('/mechanic-data', [ShopMechanicController::class, 'mechanicData']);
